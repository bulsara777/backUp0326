...
<style>
    ...
    .sub-title{width:1000px; height:129px; padding-top:65px; margin:0 auto; background-image:url(resources/images/mypagetop.jpg); background-repeat:no-repeat; color:#fff; font-size:320%; text-align:center; margin:0px auto;}
    
    .sub-tabs{width:1000px; background-color:#fafafa; border-top:1px solid #d0d0d0; border-bottom:1px solid #d0d0d0; margin:0px auto;}
    
    .sub-tabs ul{width:1000px; margin:0 auto; text-align:center; overflow:hidden;}
