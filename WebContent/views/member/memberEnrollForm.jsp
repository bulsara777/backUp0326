				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input name="name" id="userName" title="이름" class="input name" type="text" maxlength="10" required="">
							</td>
						</tr>
						<tr>
						...
						<th><span class="essential">*</span>휴대폰번호</th>
							<td>
								<input name="phone" id="userPhone" title="휴대폰번호" class="input phone" type="tel" maxlength="11" placeholder="휴대폰번호 (숫자만)" required="">
							</td>
						</tr>
						<tr>
						<th>전화번호</th>
